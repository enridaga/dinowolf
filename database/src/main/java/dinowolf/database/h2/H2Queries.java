...
public class H2Queries {
	...
	public static final String INSERT_ANNOTATION_LOG = "INSERT INTO ANNOTATION_LOG (PORTPAIR, BUNDLE, RECOMMENDED, ACTION) VALUES (?,?,?,?)";
	...
	public static final String SELECT_BUNDLE_NEVER_ANNOTATED = "SELECT ID FROM BUNDLE WHERE ID NOT IN (SELECT BUNDLE FROM PORTPAIR WHERE PORTPAIR.ID NOT IN (SELECT PORTPAIR FROM ANNOTATION_UNIT)) LIMIT 1";
	public static final String SELECT_BUNDLE_ANNOTATING = "SELECT ANNOTATION_LOG.BUNDLE FROM ANNOTATION_LOG, PORTPAIR WHERE ACTION != 'S' AND PORTPAIR!=PORTPAIR.ID LIMIT 1";
