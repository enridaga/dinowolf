...
public class H2Queries {
	...
	public static final String INSERT_ANNOTATION_LOG = "INSERT INTO ANNOTATION_LOG (PORTPAIR, BUNDLE, RECOMMENDED, ACTION, ANNOTATIONS, DURATION, FROMREC, AVGRANK, AVGREL) VALUES (?,?,?,?,?,?,?,?,?)";
	...
	public static final String SELECT_ANNOTATION_LOGS = "SELECT BUNDLE.FILE, PORTPAIR.NAME, U.ANNOTATION, L.RECOMMENDED, L.ACTION, L.ID, L.ANNOTATIONS, L.DURATION, L.FROMREC, L.AVGRANK, L.AVGREL FROM BUNDLE, PORTPAIR, ANNOTATION_LOG L LEFT OUTER JOIN ANNOTATION_UNIT U ON U.PORTPAIR = L.PORTPAIR WHERE BUNDLE.ID = PORTPAIR.BUNDLE AND PORTPAIR.ID = L.PORTPAIR ORDER BY L.ID";
