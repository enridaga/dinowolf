System.register(['angular2/core', './feature-dialog.component', './workflow-details.service', './app.models'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            FeaturesTable = (function () {
                function FeaturesTable(_service) {
                    this._service = _service;
                }
                FeaturesTable.prototype.ngOnInit = function () {
                    var _this = this;
            ...
            exports_1("FeaturesTable", FeaturesTable);
        }
    }
});
